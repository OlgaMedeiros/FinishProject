...
**Окончательный ожидаемый результат после каждого сценария - Запись на курс успешно завершена**
 ...
 Сценарий 2
 1. Ввести данные в поле на кириллице + цифры.
 2. Ввести в поле номер телефона цифрами в диапазоне от 9 до 14 цифр с знаком + впереди.
 3. Кликнуть кнопку "записаться".

 Сценарий 3
 1. Ввести данные в поле иероглифами.
 2. Ввести в поле номер телефона цифрами в диапазоне от 9 до 14 цифр с знаком + впереди.
 3. Кликнуть кнопку "записаться".

 Сценарий 4
 1. Ввести данные в поле спецсимволами.
 2. Ввести в поле номер телефона цифрами в диапазоне от 9 до 14 цифр с знаком + впереди.
 3. Кликнуть кнопку "записаться".

 Сценарий 5
 1. Ввести данные в поле на латинице +цифры.
 2. Ввести в поле номер телефона цифрами в диапазоне от 9 до 14 цифр с знаком + впереди.
 3. Кликнуть кнопку "записаться".

 Сценарий 6
 1. Ввести данные в поле на латинице с спецсимволами.
 2. Ввести в поле номер телефона цифрами в диапазоне от 9 до 14 цифр с знаком + впереди.
 3. Кликнуть кнопку "записаться".
